...
def check_event(ai_setting, screen, stats, sb, play_button, ship, aliens, 
        bullets):
...
def check_play_button(ai_setting, screen, stats, sb, play_button, ship, 
    ...
    if play_button.rect.collidepoint(mouse_x, mouse_y) and not stats.game_active:
        # 重置游戏设置
        ai_setting.initialize_gynamic_settings()
        #隐藏光标
...
def update_screen(ai_setting, screen, stats, sb, ship, aliens, bullets,
        play_button):
    """更新屏幕上的图像，并切换到新屏幕"""
...
def update_bullets(ai_setting, screen, stats, sb, ship, aliens, bullets):
    ...
    check_bullet_alien_collisions(ai_setting, screen, stats, sb, ship, 
        aliens, bullets)
...
def check_bullet_alien_collisions(ai_setting, screen, stats, sb, ship, 
        aliens, bullets):
    """响应子弹和外星人的碰撞"""
    # 删除发生碰撞的子弹和外星人
...
# ~ def check_events(ai_setting, screen, stats, paly_button, ship, bullets):
